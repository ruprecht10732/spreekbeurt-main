...
const TOUR_SHOTS: Record<keyof typeof THEATRE_TOUR_SEQUENCE_POSITIONS, CameraShot> = {
  ...
  mercurius: {
    offset: { x: 1.4, y: 0.5, z: 1.2 },
    lookOffset: { x: 0.1, y: 0, z: 0 },
    drift: { x: -0.0008, y: 0.0004, z: 0.0008 },
    mouseParallax: { x: 0.2, y: 0.2, z: 0 },
    lerp: 0.032,
    flareVisible: false,
  },
  venus: {
    offset: { x: 2.5, y: 0.6, z: 2.4 },
    lookOffset: { x: 0, y: 0.1, z: 0 },
    drift: { x: 0.001, y: 0.0004, z: -0.0007 },
    mouseParallax: { x: 0.25, y: 0.25, z: 0 },
    lerp: 0.03,
    flareVisible: false,
  },
  aarde: {
    offset: { x: 2, y: 0.5, z: 2.2 },
    lookOffset: { x: 0, y: 0.1, z: 0 },
    drift: { x: 0.0008, y: 0.0003, z: -0.0006 },
    mouseParallax: { x: 0.2, y: 0.2, z: 0 },
    lerp: 0.032,
    flareVisible: false,
  },
  maan: {
    offset: { x: 0.008, y: 0.005, z: 0.009 },
    lookOffset: { x: -0.001, y: 0.003, z: 0 },
    drift: { x: -0.0002, y: -0.00005, z: -0.0003 },
    mouseParallax: { x: 0.0001, y: 0.0001, z: 0 },
    lerp: 0.04,
    flareVisible: false,
  },
  mars: {
    offset: { x: 1.8, y: 0.6, z: 1.6 },
    lookOffset: { x: 0, y: 0.1, z: 0 },
  ...
  starman: {
    offset: { x: 0.4, y: 0.18, z: 0.55 },
    lookOffset: { x: 0, y: 0.02, z: 0 },
    drift: { x: 0.0003, y: 0.0002, z: -0.0002 },
    mouseParallax: { x: 0.04, y: 0.04, z: 0 },
    lerp: 0.035,
    flareVisible: false,
  },
  saturnus: {
    offset: { x: -22, y: 6, z: 20 },
    lookOffset: { x: 0, y: -1, z: 0 },
  ...
  columbia: {
    offset: { x: 4.6, y: 1.7, z: 5.4 },
    lookOffset: { x: -0.6, y: -0.2, z: -0.6 },
    drift: { x: -0.0005, y: 0.0003, z: -0.0004 },
    mouseParallax: { x: 0.12, y: 0.12, z: 0 },
    lerp: 0.042,
    flareVisible: false,
  },
  'jupiter-einde': {
