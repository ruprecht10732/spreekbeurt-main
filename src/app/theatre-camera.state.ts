...
const SHOTS: Record<keyof typeof THEATRE_SLIDE_SEQUENCE_POSITIONS, CameraShot> = {
  ...
  h3: {
    offset: { x: -20, y: 20, z: 40 },
    lookOffset: { x: 0, y: 0, z: -8 },
...
const TOUR_SHOTS: Record<keyof typeof THEATRE_TOUR_SEQUENCE_POSITIONS, CameraShot> = {
  ...
  aarde: {
    offset: { x: 6.8, y: 2.6, z: 6.4 },
    lookOffset: { x: 0.55, y: 0.95, z: 0.45 },
  ...
  mars: {
    offset: { x: 5.7, y: 2.1, z: 5.1 },
    lookOffset: { x: 0.35, y: 0.75, z: 0.25 },
