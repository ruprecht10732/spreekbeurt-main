...
const TOUR_SHOTS: Record<keyof typeof THEATRE_TOUR_SEQUENCE_POSITIONS, CameraShot> = {
  ...
  aarde: {
    offset: { x: 2.2, y: 0.8, z: 2.5 },
    lookOffset: { x: 0, y: 0.15, z: 0 },
  ...
  maan: {
    offset: { x: 0.07, y: 0.018, z: 0.085 },
    lookOffset: { x: -0.012, y: 0.014, z: -0.018 },
    drift: { x: -0.032, y: -0.006, z: -0.055 },
    mouseParallax: { x: 0.0015, y: 0.0015, z: 0 },
    lerp: 0.028,
    flareVisible: false,
  },
  mars: {
  ...
  pluto: {
    offset: { x: 16, y: 7, z: 15 },
    lookOffset: { x: 0, y: 0, z: 0 },
    drift: { x: 0.001, y: 0.0004, z: -0.0006 },
    mouseParallax: { x: 0.5, y: 0.5, z: 0 },
    lerp: 0.022,
    flareVisible: true,
  },
