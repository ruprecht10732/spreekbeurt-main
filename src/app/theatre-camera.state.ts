...
const TOUR_SHOTS: Record<keyof typeof THEATRE_TOUR_SEQUENCE_POSITIONS, CameraShot> = {
  ...
  maan: {
    offset: { x: 0.13, y: 0.03, z: 0.30 },
    lookOffset: { x: 0.11, y: 0.01, z: 0.26 },
    drift: { x: 0.00005, y: 0.00003, z: 0 },
    mouseParallax: { x: 0.003, y: 0.003, z: 0 },
    lerp: 0.012,
    flareVisible: false,
  },
  mars: {
  ...
  starman: {
    offset: { x: 1.5, y: 0.6, z: 2.0 },
    lookOffset: { x: 0, y: 0.1, z: 0 },
    drift: { x: 0.001, y: 0.0005, z: -0.0006 },
    mouseParallax: { x: 0.25, y: 0.25, z: 0 },
    lerp: 0.03,
    flareVisible: true,
  },
